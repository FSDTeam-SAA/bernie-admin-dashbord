  ...
  return (
    <>
      <div className="flex h-screen sticky top-0 bottom-0 w-[400px] flex-col bg-white z-50 shadow-[4px_0px_40px_0px_rgba(0,0,0,0.04)]">
        ...
        {/* Navigation Links */}
        <nav className="flex-1 space-y-1 flex flex-col items-stretch px-4 overflow-y-auto [scrollbar-color:#CBD5E1_transparent] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-slate-300 hover:[&::-webkit-scrollbar-thumb]:bg-slate-400">
